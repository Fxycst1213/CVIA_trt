...
namespace model
{
    ...
    {
        device dev = GPU;
        int num_cls = 1000;                                          // 分类数
        preprocess::tactics tac = preprocess::tactics::GPU_BILINEAR; // 插值方法使用GPU双线性
        image_info img = {640, 640, 3};
        task_type task = POSE;
